...
void RepeaterBookResultsWidget::duplicateTableRow()
{
}

void RepeaterBookResultsWidget::removeTableRow()
{
}

void RepeaterBookResultsWidget::sortTableRow()
{
}

std::vector<Mongo::BSONDoc> RepeaterBookResultsWidget::getVisibleDocs() const
{
...
void RepeaterBookResultsWidget::filterTableColumn()
{
  bool ok;
...
void RepeaterBookResultsWidget::hideRow()
{
  for (const auto& item : _tableWidget->selectedItems())
  {
...
void RepeaterBookResultsWidget::removeValueAction()
{
}

void RepeaterBookResultsWidget::addValueAction()
{
}

void RepeaterBookResultsWidget::itemUpdate(QTableWidgetItem* /*item*/)
{
}

void RepeaterBookResultsWidget::metaUpdate()
{
}

void RepeaterBookResultsWidget::updateTable()
{
}

void RepeaterBookResultsWidget::cellSelected(int, int)
{
}

void RepeaterBookResultsWidget::update()
{
  if (_bsonDocs.empty())
    return;
...
void RepeaterBookResultsWidget::setDebug(bool /*state*/)
{
}
